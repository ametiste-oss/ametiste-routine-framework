...
//        final JdbcTaskReflection jdbcTaskReflection =
//                new JdbcTaskReflection(taskTable, operationTable, task.entityId(), jdbcTemplate);
//        task.reflectAs(jdbcTaskReflection);
//        jdbcTaskReflection.saveReflection();
//    }
//
//    @Override
//    public Task findTaskByOperationId(UUID taskId) {
//
//        final String taskId = jdbcTemplate.queryForObject(
//            String.format("SELECT task_id FROM %s WHERE id = ? FOR UPDATE", operationTable), String.class, taskId.toString()
//        );
//
//        if (taskId == null) {
//            throw new RuntimeException("Task not found by operation id: " + taskId.toString());
//        }
//
//        final JdbcTaskReflection jdbcTaskReflection =
